...
\begin{figure*}[t]
\centering
\includegraphics[width=0.3\linewidth]{binary_shape.pdf}
\includegraphics[width=0.43\linewidth]{google.pdf}\hfill
\includegraphics[width=0.22\linewidth]{google_disks.pdf}
...
Using~\refeq{eq:diskcost} to compare encodings of \emph{all} contained disks provides a more robust error metric.}
\label{fig:google}
\end{figure*}
