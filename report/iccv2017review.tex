...
\emph{Bone graphs} offer improved stability and a more intuitive representation of an object's parts, compared to
skeletons and shock graphs, by identifying and analyzing ligature structures.

In recent years, the value of the binary MAT has been more appreciated by the graphics community.
...
in the interior of the shape. The radius $r(\p{})$ of the disk is the distance between $\p{}$ and 
...
mapping $O$ to the set of tuples $(\p{},r(\p{})) \in \mathbb{R}^2 \times \mathbb{R}$.
